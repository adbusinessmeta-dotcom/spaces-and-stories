...
const DEFAULT_IMAGES: ImageItem[] = [
  { src: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?q=80&w=774&auto=format&fit=crop', alt: 'Modern living room' },
  { src: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?q=80&w=772&auto=format&fit=crop', alt: 'Cozy bedroom' },
  { src: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?q=80&w=774&auto=format&fit=crop', alt: 'Kitchen design' },
  { src: 'https://images.unsplash.com/photo-1615529328331-f8917597711f?q=80&w=774&auto=format&fit=crop', alt: 'Dining room' },
  { src: 'https://images.unsplash.com/photo-1616137466211-f939a420be84?q=80&w=774&auto=format&fit=crop', alt: 'Bathroom design' },
  { src: 'https://images.unsplash.com/photo-1616486029423-aaa4789e8c9a?q=80&w=774&auto=format&fit=crop', alt: 'Home office' },
  { src: 'https://images.unsplash.com/photo-1615874959474-d609969a20ed?q=80&w=774&auto=format&fit=crop', alt: 'Living space' },
  { src: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?q=80&w=800&auto=format&fit=crop', alt: 'Interior design' }
];
...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback((el: HTMLElement) => {
    ...
    if (!mainR || !frameR || tileR.width <= 0 || !viewerRef.current) {
      openingRef.current = false;
      onEnlargeToggle?.(false);
      focusedElRef.current = null;
  ...
  }, [enlargeTransitionMs, lockScroll, onEnlargeToggle, segments, unlockScroll]);
